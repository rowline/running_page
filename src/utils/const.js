// const
const MAPBOX_TOKEN =
  'pk.eyJ1Ijoicm93bGluZWxsIiwiYSI6ImNsaGlxbW5tajBhbHkzZ21tbXpwczcxcTMifQ.azIaKyj7Q2KlOG9R5XXswA';
...
const CHINESE_INFO_MESSAGE = (yearLength, year) => {
  ...
  return `我用 App Watch 记录自己跑步 ${yearLength} 年了，下面列表展示的是${yearStr}的数据。`;
}
